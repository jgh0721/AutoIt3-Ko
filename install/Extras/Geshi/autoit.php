 ...
 * autoit.php
 * --------
 * Author: big_daddy (robert.i.anthony@gmail.com), guinness & Tlem
 ...
 * CHANGES
 * -------
 * Release 1.0.8.11 (2013/01/04) by guinness MVP
 * - Fixed: #endregion not highlighting correctly.
 * - Fixed: AutoItWrapper directives and settings are now highlighted correctly.
 * - Fixed: Highlighting of hex values and complex math statements.
 * - Fixed: Include file name to the correct colour scheme.
 * - Fixed: Incorrectly highlighting _ (underscore.) (NOT FIXED)
 * - Fixed: Upper case #include being incorrectly highlighted.
 * - Fixed: Variables and macros were being incorrectly highlighted.
 * - Updated: The functions, keywords and macros list from au3.api V3.3.8.1.
 * - Updated: To the current AutoIt color scheme V3.3.8.1.

 * Release 1.0.8.1 (2008/09/15) by Tlem (tlem@tuxolem.fr)
 ...
 * - Updated: With au3.api (09.02.2008).
 * - Updated: 16 May 2008 - v3.2.12.0
...
$language_data = array (
    ...
    'KEYWORDS' => array(
        1 => array(
            ...
            'Return','Select','Static','Step','Switch','Ternary','Then','To',
        ...
        3 => array(
            ...
            'StringStripWS','StringToASCIIArray','StringToBinary',
            'StringTrimLeft','StringTrimRight','StringUpper','Tan','TCPAccept',
            'TCPCloseSocket','TCPConnect','TCPListen','TCPNameToIP','TCPRecv',
            'TCPSend','TCPShutdown','TCPStartup','TimerDiff','TimerInit',
            ...
            'UBound','UDPBind','UDPCloseSocket','UDPOpen','UDPRecv','UDPSend',
            'UDPShutdown','UDPStartup','VarGetType','WinActivate','WinActive',
            'WinClose','WinExists','WinFlash','WinGetCaretPos',
        ...
        4 => array(
            ...
            'GDIPlus_BitmapCloneArea','GDIPlus_BitmapCreateFromFile',
            'GDIPlus_BitmapCreateFromGraphics',
            'GDIPlus_BitmapCreateFromHBITMAP','GDIPlus_BitmapCreateFromScan0',
            ...
            'GDIPlus_DrawImagePoints','GDIPlus_Encoders',
            ...
            'GDIPlus_FontFamilyDispose','GDIPlus_GraphicsClear',
            ...
            'GDIPlus_GraphicsDrawImageRectRect','GDIPlus_GraphicsDrawLine',
            ...
            'GDIPlus_GraphicsFillEllipse','GDIPlus_GraphicsFillPie',
            ...
            'GDIPlus_ImageDispose','GDIPlus_ImageGetFlags',
            ...
            'GDIPlus_MatrixCreate','GDIPlus_MatrixDispose',
            'GDIPlus_MatrixRotate','GDIPlus_MatrixScale',
            'GDIPlus_MatrixTranslate','GDIPlus_ParamAdd','GDIPlus_ParamInit',
            'GDIPlus_PenCreate','GDIPlus_PenDispose','GDIPlus_PenGetAlignment',
            'GDIPlus_PenGetColor','GDIPlus_PenGetCustomEndCap',
            'GDIPlus_PenGetDashCap','GDIPlus_PenGetDashStyle',
            'GDIPlus_PenGetEndCap','GDIPlus_PenGetWidth',
            'GDIPlus_PenSetAlignment','GDIPlus_PenSetColor',
            'GDIPlus_PenSetCustomEndCap','GDIPlus_PenSetDashCap',
            'GDIPlus_PenSetDashStyle','GDIPlus_PenSetEndCap',
            'GDIPlus_PenSetWidth','GDIPlus_RectFCreate','GDIPlus_Shutdown',
            'GDIPlus_Startup','GDIPlus_StringFormatCreate',
            'GDIPlus_StringFormatDispose','GDIPlus_StringFormatSetAlign',
            'GetIP','GUICtrlAVI_Close','GUICtrlAVI_Create','GUICtrlAVI_Destroy',
            'GUICtrlAVI_IsPlaying','GUICtrlAVI_Open','GUICtrlAVI_OpenEx',
            'GUICtrlAVI_Play','GUICtrlAVI_Seek','GUICtrlAVI_Show',
            'GUICtrlAVI_Stop','GUICtrlButton_Click','GUICtrlButton_Create',
            ...
            'StringReverse','StringTitleCase','StringToHex','TCPIpToName',
            'TempFile','TicksToTime','Timer_Diff','Timer_GetIdleTime',
        ...
        5 => array(
            ...
            'NoAutoIt3Execute','NoTrayIcon','OnAutoItStartRegister',
            'RequireAdmin'
            ),
        6 => array(
            ...
            'AutoIt3Wrapper_Versioning_Parameters','Obfuscator_Ignore_Funcs',
            'Obfuscator_Ignore_Variables','Obfuscator_Off','Obfuscator_On',
            'Obfuscator_Parameters','Tidy_Off','Tidy_On','Tidy_Parameters'
            ),
        7 => array(
