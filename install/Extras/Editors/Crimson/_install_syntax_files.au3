...
Local $answer = MsgBox(BitOR($MB_YESNO, $MB_SYSTEMMODAL), "Crimson Editor", "This script will attempt to automatically install syntax highlighting files for Crimson Editor.  Run?")
