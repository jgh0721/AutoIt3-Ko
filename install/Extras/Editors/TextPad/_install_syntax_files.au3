...
Local $answer = MsgBox(BitOR($MB_YESNO, $MB_SYSTEMMODAL), "TextPad v4/5", "This script will attempt to automatically install syntax highlighting and clip library files for TextPad v4/5.  Run?")
